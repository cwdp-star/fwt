...
export default {
	...
	theme: {
		...
		extend: {
			fontFamily: {
				'along-serif': ['Playfair Display', 'serif'],
			},
			colors: {
			...
			animation: {
				...
				'scale-in-delay-200': 'scale-in 0.5s ease-out 0.2s both',
				'scale-in-delay-400': 'scale-in 0.5s ease-out 0.4s both',
				'scale-in-delay-600': 'scale-in 0.5s ease-out 0.6s both'
			}
		}
	},
